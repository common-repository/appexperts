...
if (!class_exists('App_Expert_Pages_Controller')){

	class App_Expert_Pages_Controller extends WP_REST_Posts_Controller {
		...
		public function get_item($request){
			...
			return App_Expert_Response::get_api_single_success_response(
				$response,
				'app_expert_page_retrieved',
				'retrieved requested page'
			);
		}
...
$app_expert_pages_controller = new App_Expert_Pages_Controller();
$app_expert_pages_controller->register_routes();
