...
class App_Expert_Peepso_Friends_Notification {
    ...
    public function add_additional_params($_notification){
        if(in_array($_notification->type,$this->notification_types)){
            $_notification = App_Expert_Peepso_Friends_Notification_helper::get_extra_data($_notification);
        }
...
new App_Expert_Peepso_Friends_Notification();